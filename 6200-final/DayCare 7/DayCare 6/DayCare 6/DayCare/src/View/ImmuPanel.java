             ...
             for(StudentImmu immu:studentimmus){
                 ...
                 if(immu.getName()== "Hib"){
                     s.remove("Hib");
                      ...
                      if(immu.getName()== "DTaP" && immu.getDose()==4){
                        s.remove("DTap");
                     }
                    if(immu.getName()== "Polio" && immu.getDose()==3){
                        s.remove("Polio");
                     } 
                      if(immu.getName()== "Hepatitis B" && immu.getDose()==3){
                        s.remove("Hepatitis B");
                     }
                      if(immu.getName()== "MMR" && immu.getDose()==1){
                        s.remove("MMR");
                     }
                      if(immu.getName()== "Varicella" && immu.getDose()==1){
                        s.remove("Varicella");
                     }
                 }
             }
...
//                     s.remove("Hib");
//                 }
                      if(immu.getName()== "DTaP" && immu.getDose()==5){
                        s.remove("DTap");
                     }
                    if(immu.getName()== "Polio" && immu.getDose()==4){
                        s.remove("Polio");
                     } 
                      if(immu.getName()== "Hepatitis B" && immu.getDose()==3){
                        s.remove("Hepatitis B");
                     }
                      if(immu.getName()== "MMR" && immu.getDose()==2){
                        s.remove("MMR");
                     }
                      if(immu.getName()== "Varicella" && immu.getDose()==2){
                        s.remove("Varicella");
                     }
                 }
             }
